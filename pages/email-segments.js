...
import { Users, Filter, Save, Trash2, ArrowLeft, Send, X, RefreshCw } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center mb-4">
        <button onClick={() => router.push('/broadcasts')} className="flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-md">
